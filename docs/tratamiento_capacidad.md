...
Versión: **`capacidad_q05_q06_q07_v2`**.

Si una fila RAW en alcance tiene Q05, Q06 o Q07, queda pendiente todo el grupo
...
Q07 es una hipótesis fuerte que exige validación. Q08/Q09 solo se reportan y no
provocan exclusión por sí solos. Q00 sigue bloqueando archivos; Q04 se limita a
...
- `pendientes_capacidad.csv`: hallazgos Q05/Q06/Q07 en alcance, valores fuente y
...
`reglas_aplicadas` contiene `["Q05", "Q06", "Q07"]`;
`reglas_solo_auditadas` contiene `["Q01", "Q02", "Q03", "Q04", "Q08", "Q09"]`.
...
FastAPI, backend y frontend conservan su comportamiento actual. Q07 se trata
solo en esta preparación histórica. La cantidad de ejemplos y los valores
derivados pueden cambiar al reconstruir la preparación, sin cambiar sus fórmulas.
